...
namespace DesignPatterns_RemoteProxies_RemoteProxy
{
    ...
    { // wow, this one class impersonates *both* the remote database
        ...
        public IAcct login(string id)
        {
            ...
            remoteAccount = new Account(id, (int)rpcToDatabase(remoteDatabase.loginRemote, id));
              // method  rpcToDatabase is coded below
        ...
        public object logout(string id)
        {
            ...
            {
                rpcToDatabase(remoteDatabase.logoutRemote, accountid, remoteAccount.getBalance());
                remoteAccount = null;
            }
            return null;
        }
